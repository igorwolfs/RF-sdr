...
# Title: GNURadio intro
# Description: https://pnsaeta.github.io/Learning_SDR/lesson08a.html
...
class intro(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GNURadio intro", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GNURadio intro")
        ...
        self.settings = Qt.QSettings("GNU Radio", "intro")
        ...
        # Variables
        ##################################################
        self.tone_freq = tone_freq = 50000
        ...
        self._tone_freq_range = qtgui.Range(-100000, 100000, 1, 50000, 200)
        ...
        self._rx_gain_range = qtgui.Range(0, 70, 1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, tone_freq, 1, 0, 0)
...
def main(top_block_cls=intro, options=None):
